...
class ExtendedKalmanFilter(object):
    ...
    def __init__(self, dim_x, dim_z, HJacobian,Hx,dim_u=0):
    ...
    def predict_update(self, z, args=(), hx_args=(), u=0):
    ...
    def update(self, z, R=None, args=(), hx_args=(),
        ...
        self.y = self.y.reshape([self.dim_z,1])
        # print(self.y)
